...
const ProductBanner = () => {
  return (
    <div className="relative w-full min-h-[300px] md:h-[400px] bg-white flex flex-col md:flex-row items-center">
    {/* Text Content Section (Top on mobile, Left on desktop) */}
    <div className="w-full md:w-1/2 p-6 md:pl-12 lg:pl-16 md:pr-8 text-center md:text-left">
    ...
    {/* Image Section (Bottom on mobile, Right on desktop) with Animated Glow */}
